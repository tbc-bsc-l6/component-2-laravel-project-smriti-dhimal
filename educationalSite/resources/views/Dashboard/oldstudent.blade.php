        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                <p class="stat-number stat-pass">
                    {{ $completedModules->filter(fn($m) => $m->pivot->result == 'PASS')->count() }}
                </p>
                <p class="stat-label">Passed</p>
            </div>
            <div class="stat-card">
                <p class="stat-number stat-fail">
                    {{ $completedModules->filter(fn($m) => $m->pivot->result == 'FAIL')->count() }}
                </p>
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        {{ $module->pivot->start_date ? \Carbon\Carbon::parse($module->pivot->start_date)->format('M d, Y') : 'N/A' }}
                    </td>
                    <td>
                        {{ $module->pivot->completed_at ? \Carbon\Carbon::parse($module->pivot->completed_at)->format('M d, Y') : 'N/A' }}
                    </td>
                </tr>
                @endforeach
            </tbody>
